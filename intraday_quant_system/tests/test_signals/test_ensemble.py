...
def test_ensemble_scoring():
    ...
    score = scorer.compute_score(
        lgbm_prob=0.9,  # 0.9 * 0.25 = 0.225
        tabnet_prob=0.5,  # 0.5 * 0.25 = 0.125
        meta_prob=0.7,  # 0.7 * 0.30 = 0.21
        sentiment_score=0.8,  # normalized to 0.9 * 0.10 = 0.09
        regime_score=1.0,  # 1.0 * 0.10 = 0.10
    )
    # expected: 0.225 + 0.125 + 0.21 + 0.09 + 0.10 = 0.75
